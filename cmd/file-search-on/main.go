...
var CLI struct {
	...
	UnusedExports      UnusedExportsCmd      `cmd:"" name:"unused-exports" help:"Exported symbols referenced only within their own package — candidates to unexport and shrink the public API surface. The subtler complement to dead-code. Go / Python / Rust / TypeScript / JavaScript (more languages rolling out). e.g. unused-exports -d ."`
