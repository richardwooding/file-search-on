...
var CLI struct {
	...
	UnusedExports      UnusedExportsCmd      `cmd:"" name:"unused-exports" help:"Exported Go symbols referenced only within their own package — candidates to unexport and shrink the public API surface. The subtler complement to dead-code. Go-only; run at the module root. e.g. unused-exports -d ."`
