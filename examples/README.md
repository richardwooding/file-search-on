...
| [`astronomy.md`](./astronomy.md) | FITS + VOTable + HDF5 — astronomical data formats. FITS: `telescope`, `instrument`, `object`, `observer`, `exptime`, `ra`, `dec`, `bitpix`, `naxis*`, `hdu_count`, `fits_kind`. VOTable: `votable_version`, `table_count`, `total_rows`, `field_names`, `field_units`, `field_ucds`, `votable_data_format`. HDF5: `hdf5_format_version`, `hdf5_size_of_offsets`, `hdf5_size_of_lengths` |
