...
| [`astronomy.md`](./astronomy.md) | FITS (Flexible Image Transport System) — `telescope`, `instrument`, `object`, `observer`, `date_obs` (→ `taken_at`), `exptime`, `filter`, `ra`, `dec`, `bitpix`, `naxis*`, `hdu_count`, `fits_kind` |
