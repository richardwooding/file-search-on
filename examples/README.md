...
| [`astronomy.md`](./astronomy.md) | FITS + VOTable — astronomical data formats. FITS: `telescope`, `instrument`, `object`, `observer`, `exptime`, `ra`, `dec`, `bitpix`, `naxis*`, `hdu_count`, `fits_kind`. VOTable: `votable_version`, `table_count`, `total_rows`, `field_names`, `field_units`, `field_ucds`, `votable_data_format` |
