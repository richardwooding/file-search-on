...
func Schema() SchemaDoc {
	return SchemaDoc{
		...
		TypeSpecific: []AttributeDoc{
			{"title", "string", "title (front-matter, markdown h1, HTML title, PDF title, EPUB, office)"},
			...
			{"language", "string", "language code (EPUB, HTML <html lang>, markdown front-matter, office)"},
