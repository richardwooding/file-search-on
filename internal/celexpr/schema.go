...
func Schema() SchemaDoc {
	return SchemaDoc{
		...
		TypeSpecific: []AttributeDoc{
			...
			{"created_at", "timestamp", "disk-image creation timestamp. VHD: TimeStamp field (seconds since 2000-01-01 UTC). ISO: volume_creation_date_and_time from the PVD. Empty for other disk-image formats and non-disk-image files."},
