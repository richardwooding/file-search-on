...
func Schema() SchemaDoc {
	return SchemaDoc{
		Common: []AttributeDoc{
			...
			{"is_source", "bool", "true if source code (Go, Python, JS/TS, Rust, C/C++, Java, Ruby, Swift, Kotlin, Shell, Lua, Elixir, Clojure, Haskell, OCaml, Zig — content_type starts with 'source/')"},
		},
