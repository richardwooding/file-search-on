...
func New(expr string) (*Evaluator, error) {
	opts := []cel.EnvOption{
		...
		cel.Variable("is_c2pa", cel.BoolType),
		cel.Variable("c2pa_claim_generator", cel.StringType),
		...
		cel.Variable("c2pa_verified_signer", cel.StringType),
		cel.Variable("c2pa_verified_signed_at", cel.TimestampType),
		cel.Variable("c2pa_validation_status", cel.StringType),
		cel.Variable("c2pa_bound", cel.StringType),
		cel.Variable("c2pa_identity_count", cel.IntType),
		cel.Variable("c2pa_identity_valid", cel.BoolType),
		cel.Variable("c2pa_identity_trusted", cel.BoolType),
		cel.Variable("c2pa_identity_roles", cel.ListType(cel.StringType)),
		cel.Variable("c2pa_identity_sig_types", cel.ListType(cel.StringType)),
