...
// document content type — currently OOXML office formats (DOCX / XLSX /
// PPTX), ODT, and EPUB. For everything else it returns "" and a nil
// error; the caller should fall through to its existing text-file body
// reader.
//
