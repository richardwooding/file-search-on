...
| `coupling [--top N]` | Afferent/efferent coupling + instability (Martin metrics) — fragile architectural seams. Go (packages) + Rust (crates) + Java (packages) + C# (namespaces) + Python (packages) + JS/TS (directory modules); more langs → #467 | [examples/source-code.md](./examples/source-code.md) |
