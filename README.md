...
| `complexity [expr]` | Functions ranked by cyclomatic complexity (worst-first) — maintenance hotspots. Also reports SonarSource **cognitive complexity** (nesting-weighted; Go / Python / JS / TS / Java / Rust, remaining languages → #491) | [examples/source-code.md](./examples/source-code.md) |
